...
class ListOfAllCustomerOrder extends StatefulWidget {
  ListOfAllCustomerOrder({Key? key}) : super(key: key);

  @override
  State<ListOfAllCustomerOrder> createState() => _ListOfAllOrderState();
}

class _ListOfAllOrderState extends State<ListOfAllCustomerOrder> {
  ...
  loadData() async {
    ...
    var id = await storage.read(key: 'customer_id');

    final response = await NetworkService.sendAuthRequest(
      url: StaticValues.host + '/api/order/customer',
